...
+ (id)adScrollViewWithFrame:(CGRect)frame localImageLinkURL:(NSArray *)imageLinkURL pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    ADLoopView * adView = [ADLoopView adScrollViewWithFrame:frame imageLinkURL:imagePaths   pageControlShowStyle:PageControlShowStyle];
    return adView;
}
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _centerAdLabel.frame = CGRectMake(0, kAdViewHeight - 30, kAdViewWidth - CGRectGetWidth(_centerAdLabel.bounds) - CGRectGetWidth(_pageControl.bounds) , 30);
    ...
    _centerAdLabel.preferredMaxLayoutWidth = kAdViewWidth - CGRectGetWidth(_centerAdLabel.bounds) - CGRectGetWidth(_pageControl.bounds) - 20;
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    {
        _pageControl.frame = CGRectMake( kAdViewWidth - 20*_pageControl.numberOfPages, kAdViewHeight - 25, 20*_pageControl.numberOfPages, 20);
    }
