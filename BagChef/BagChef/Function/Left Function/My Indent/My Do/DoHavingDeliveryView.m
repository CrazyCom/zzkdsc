...
@interface DoHavingDeliveryView () {
...
@end
@implementation DoHavingDeliveryView
...
//            NSString *doHavingCellID = @"doHavingCellID";
//            DoHavingDeliveryViewTableViewCell *doHavingDeliveryCell = [tableView dequeueReusableCellWithIdentifier:doHavingCellID];
//            
//            if (!doHavingDeliveryCell) {
//                
//                doHavingDeliveryCell = [[DoHavingDeliveryViewTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:doHavingCellID];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *doHavingDeliveryCellID = @"doHavingDeliveryCellID";
    DoHavingDeliveryViewTableViewCell *doHavingDeliveryCell = [tableView dequeueReusableCellWithIdentifier:doHavingDeliveryCellID];
    ...
    for (int i = 0 ; i < array.count; i ++) {
        ...
        if (!doHavingDeliveryCell) {
            ...
            doHavingDeliveryCell = [[DoHavingDeliveryViewTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:doHavingDeliveryCellID];
            doHavingDeliveryCell.selectionStyle = UITableViewCellSelectionStyleNone;
