//
//  SendWaitForDeliveryViewTableViewCell.m
//  BagChef
//
...
@implementation SendWaitForDeliveryViewTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _addressOfSend.numberOfLines = 2;
        ...
        [btn setTitle:@"我开始要送镖啦" forState:UIControlStateNormal];
