...
@interface MyEnshrineOfMenuView()<UITableViewDelegate,UITableViewDataSource> {
...
@implementation MyEnshrineOfMenuView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    MyEnshrineOfMenuViewTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CELLID];
    if (!cell) {
