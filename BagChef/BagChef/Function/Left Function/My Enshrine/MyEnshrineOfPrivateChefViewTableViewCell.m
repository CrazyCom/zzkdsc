//
//  MyEnshrineOfPrivateChefViewTableViewCell.m
//  BagChef
//
...
@implementation MyEnshrineOfPrivateChefViewTableViewCell
...
//        [_headerImageView setFrame:CGRectMake(11, 11, 46 , 46 )];
...
//        [_nameLabel setFrame:CGRectMake(CGRectGetMaxX(_headerImageView.frame) + 8 , CGRectGetMinY(_headerImageView.frame), 90 , 17 )];
...
//        [_idCardImageView setFrame:CGRectMake(CGRectGetMaxX(_nameLabel.frame), CGRectGetMinY(_headerImageView.frame), 30 , 15 )];
...
//        [_healthCardImageView setFrame:CGRectMake(CGRectGetMaxX(_idCardImageView.frame) + 5, CGRectGetMinY(_headerImageView.frame), 30 , 15 )];
...
//            [_starImageView setFrame:CGRectMake(CGRectGetMaxX(_headerImageView.frame) + 8 +21 * i , CGRectGetMaxY(_headerImageView.frame) - 18 , 18 , 18 )];
...
//        [positionImageView setFrame:CGRectMake(11, CGRectGetMaxY(_headerImageView.frame) + 11, 16 , 16 )];
//        [positionImageView setImage:[UIImage imageNamed:@"tb4"]];
//        [self addSubview:positionImageView];
//        
//        _positionLabel = [[UILabel alloc]init];
//        [_positionLabel setFrame:CGRectMake(CGRectGetMaxX(positionImageView.frame) + 8, CGRectGetMaxY(positionImageView.frame) - 10, (ScreenWidth - CGRectGetMaxX(positionImageView.frame) - 8 - 10) , 10 )];
...
//            [_menuImageView setFrame:CGRectMake(11 + ((ScreenWidth - 22 - 10) / 3 + 5) * i , CGRectGetMaxY(_positionLabel.frame) + 10, (ScreenWidth - 22 - 10) / 3, (ScreenWidth - 22 - 16) / 3 * 0.65)];
//            [_menuImageView setBackgroundColor:[UIColor grayColor]];
//            [_menuImageView setUserInteractionEnabled:YES];
//            [self addSubview:_menuImageView];
//            
//            _nameOfMenuLabel = [[UILabel alloc]init];
//            [_nameOfMenuLabel setFrame:CGRectMake(11 + 120 * i * ratioX, CGRectGetMaxY(_menuImageView.frame) + 10, 115 * ratioX, 15 * ratioY)];
//            [_nameOfMenuLabel setText:@"创新西餐"];
//            [_nameOfMenuLabel setFont:[UIFont systemFontOfSize:14]];
//            [self addSubview:_nameOfMenuLabel];
//            
//            //已售份额
//            _numberOfSoldLabel = [[UILabel alloc]init];
//            [_numberOfSoldLabel setText:@"99999999"];
//            
//            UILabel *soldOfNum = [[UILabel alloc]init];
//            [soldOfNum setFrame:CGRectMake(CGRectGetMinX(_menuImageView.frame), CGRectGetMaxY(_menuImageView.frame) + 32 , CGRectGetWidth(_menuImageView.frame) , 15 )];
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        for (int i = 0; i < 5; i++) {
            _starImageView = [[UIImageView alloc]init];
            [_starImageView setFrame:CGRectMake(CGRectGetMaxX(_headerImageBtn.frame) + 8 +21 * i * ratioX, CGRectGetMaxY(_headerImageBtn.frame) - 18 * ratioY, 18 * ratioX, 18 * ratioY)];
            [_starImageView setImage:[UIImage imageNamed:@"star"]];
            [self addSubview:_starImageView];
        }
