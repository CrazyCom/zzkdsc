//
//  MyEnshrineOfPrivateChefViewTableViewCell.h
//  BagChef
//
...
@interface MyEnshrineOfPrivateChefViewTableViewCell : UITableViewCell
...
@property (nonatomic , copy) void(^sendBtn)(MyEnshrineOfPrivateChefViewTableViewCell *cell ,int tag);
- (void)setCellWithModel:(MyEnshrineOfPrivateChefModel *)model;
